...
<div class="topbar">
  ...
  const heroCaptions =
    lang === 'fr'
      ? { main: "Photo principale — la terrasse face à l'océan, fin de journée", bf: 'Un petit-déjeuner dressé', sushi: 'Le comptoir à sushi' }
      : { main: 'Main photo — the terrace facing the ocean, end of day', bf: 'A plated breakfast', sushi: 'The sushi counter' };
  ...
  <div class="wrap hero-grid">
    ...
    <div class="hero-media">
      ...
      <div class="hero-media-row">
        ${mediaSlot({ path: 'photos/hero-petit-dej', caption: heroCaptions.bf })}
        ${mediaSlot({ path: 'photos/hero-sushi', caption: heroCaptions.sushi })}
      </div>
    </div>
  </div>
</section>`;
